...
'''),
  ...
  Future<TestProcess> testBrowserAggregateExecutable(
    List<String> args, {
    String? workingDirectory,
  }) async {
    final pubGet = await TestProcess.start('dart', [
      'pub',
      'get',
    ...
    return TestProcess.start('dart', [
      'run',
      'test_html_builder:browser_aggregate_tests',
      ...args,
    ], workingDirectory: workingDirectory);
  }
